...
public class FloatWindowSmallView extends LinearLayout {
	...
	public FloatWindowSmallView(Context context) {
		...
		rabbitView = (ImageView) findViewById(R.id.percent);
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			rabbitView.setImageResource(R.drawable.sliderbar_menu_icon_expanded);
			isPressed = true;
...
//			updateViewStatus();
		...
		case MotionEvent.ACTION_UP:
			rabbitView.setImageResource(R.drawable.sliderbar_menu_icon);
			isPressed = false;
